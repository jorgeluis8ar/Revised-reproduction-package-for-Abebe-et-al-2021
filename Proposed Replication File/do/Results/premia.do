...
ivreg2 monthly_wage  transport workshop workshop_I2*   transport_I2* bs_experience_perm bs_earning $balance1 $balance2 [pw=ed_weight] , partial($balance2) cluster(cluster_id)
	local rz_c2 =  `e(N)'
	local r1 = 1
	local r2 = 2
	...
	#delimit ;
file open myfile using "results/tables/table_a26.tex", write replace;
