...
est2tex table_a9, replace path(results/tables) label preserve digit(3) mark(stars) fancy 
...
frmttable using "results/tables/table_a12", 	///
...
frmttable using "results/tables/table_a13", 	///
		tex fragment varlabels nocenter replace ///
		ctitle("","Quantile", "Transport", "Workshop")
...
graph export "results/figures/figure1.png", replace width(1600) height(1200)
...
foreach x in 1 2{
	...
	*/
	...
	graph export "results/figures/figure_a8_`x'.png", replace width(1600) height(1200)
...
graph export "results/figures/figure_a5.pdf", as(pdf) replace
...
graph export "results/figures/figure_a4.pdf", as(pdf) replace
restore
