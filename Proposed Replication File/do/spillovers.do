...
dataout, save("tables/table_a`tab'") tex excel replace
insheet using "tables/table_a`tab'.tex" ,clear
...
outsheet  	v1	using "tables/table_a`tab'.tex", noname noquote replace
local tab = `tab'+1
...
dataout, save(tables/table_a34) tex  replace
insheet using tables/table_a34.tex, clear
drop in 1/3
gen n = _n
drop if n == _N
drop n
...
*sort n
*replace v1 = "&  &  &  &  &  &  &  \\" in 3
outsheet  	v1	using "tables/table_a34.tex", noname noquote replace
restore
 }
