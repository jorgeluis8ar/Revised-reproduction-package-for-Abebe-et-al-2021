\begin{table}[h!]
\centering
\caption{Table 5 - \textit{Impacts on 2015 permanent employment by baseline characteristics} - Proposed Table}
\scalebox{0.8}{
\begin{tabular}{lcccccccc}
\hline 
\hline
& \multicolumn{6}{c}{Baseline characteristic status} & \multicolumn{2}{c}{Treatment effects} \\
